...
export const commandData: Command[] = [
  ...
  },
  {
    ...
    description: 'Predict whether the next card value will be higher or lower than the current one. Classic casino card game!',
    example: '$highlow 100 OR $hl 150',
    tips: 'Pay attention to the current card value to make better predictions!',
    category: 'casino'
  },
  ...
  },
  {
    ...
    usage: '$starting',
    description: 'Get your starting balance of 10,000 DYSE coins. Can only be used once per user.',
    example: '$starting',
    tips: 'Perfect for new users to get started with the economy!',
    category: 'utility'
  },
